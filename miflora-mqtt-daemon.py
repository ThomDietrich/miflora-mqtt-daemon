...
from miflora import BluepyBackend
...
for [name, mac] in config['Sensors'].items():
    ...
    flora_poller = MiFloraPoller(mac=mac, cache_timeout=miflora_cache_timeout, retries=3, adapter=used_adapter, backend=BluepyBackend)
